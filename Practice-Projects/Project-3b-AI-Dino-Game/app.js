...
function endGame(){
    var audio = document.querySelector(".die-audio")
    audio.play();
    GameOver = true;
...
// As long as the game is running, this function is call
function updateGame(){ 
...
function updateCactus() {
    var cactusXPos = CactusElem.getBoundingClientRect().x;
    var isOffSreen = cactusXPos > window.innerWidth;
    if (!isOffSreen) return ;
