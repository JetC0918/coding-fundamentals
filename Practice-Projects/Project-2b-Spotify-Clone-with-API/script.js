...
function extractTokenFromURI() {
    ...
    return null; // Return nnull if there's no token
}

function displalyUserTopItems(data){
    ...
    */
    ...
    for (let item of data.items){ 
        ...
        var image = item.album.images[1].url;
        var title = item.name;
        var subtitle = item.album.artists[0].name;
        var href = item.album.external_urls.spotify;
...
function displayFeaturedPlaylilst(data){
